...
\smallfig[h]{discontinuous}{Example \ref{eg:discontinuous}. The black dot indicates that the endpoint
...
\smallfig[h]{x-minus-cos-x}{The function $x-\cos x$ constructed in example \ref{eg:x-minus-cos-x}.}
...
\smallfig[h]{x-minus-sin-1-over-x}{The function $x-\sin 1/x$.}
...
\smallfig[h]{no-limit}{Example \ref{eg:no-limit}, the function $1/x^2$.}
...
\smallfig[h]{limit-two-sides}{Example \ref{eg:limit-two-sides}, the function $\tan^{-1}(1/x)$.}
...
\smallfig[h]{sin-x-over-x}{The graph of $\sin x/x$.}
