...
We know that integrals of this form can be done, at least in theory, using partial fractions.
The ten thousand roots of the polynomial will be ten thousand points evenly spaced around
the unit circle in the complex plane. They can be expressed as $r_k=e^{2\pi k/10000}$ for $k=0$ to 9,999.
...
$A_k\ln(x-r_k)$. I also tried inputting the integral into three different pieces of symbolic
...
buying a standalone copy of Mathematica.
