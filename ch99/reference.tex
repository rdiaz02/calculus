...
\phantomsection
\addcontentsline{toc}{chapter}{E. Reference}
\markboth{E. Reference}{E. Reference}
\chapter*{Reference}
% \setcounter{section}{0}
% \setcounter{subsection}{0}
\phantomsection
\addcontentsline{toc}{section}{E. Review}
\section*{Review}
...
\noindent\begin{tabular}{p{100mm}l} %% 30
...
\phantomsection
\addcontentsline{toc}{section}{E. Hyperbolic functions}
...
\phantomsection
\addcontentsline{toc}{section}{E. Calculus}
