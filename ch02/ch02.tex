...
\smallfig[h]{leibniz}{Gottfried Leibniz (1646-1716)}%
...
\smallfig[h]{close-up}{A close-up view of the function $x=t^2$, showing the line that connects the points $(1,1)$ and $(1.1,1.21)$.}
...
\smallfig[h]{t-squared-geometrically}{A geometrical interpretation of the derivative of $t^2$.}%
%
...
\smallfig[h]{derivative-of-sine}{Graphs of $\sin t$, and its derivative $\cos t$.}
...
\smallfig[h]{geometric-series}{The function $x=1/(1-t)$.}
...
\smallfig[ht]{berkeley}{Bishop George Berkeley (1685-1753)}%
%
...
\smallfig[h]{robinson}{Abraham Robinson (1918-1974)}
...
%
\fig[ht]{product-rule}{A geometrical interpretation of the product rule.}
...
\smallfig[h]{gear-ratio}{Example \ref{eg:gear-ratio}.}
...
\smallfig[hb]{caffeine}{Example \ref{eg:caffeine}. A typical graph of the concentration of caffeine in the blood, in units of milligrams per
...
\fig[hb]{power-ladder}{Differentiation and integration of functions of the form $x^n$. Constants
...
\smallfig[h]{resonance}{The function of problem \ref{hw:resonance}, with $a=3$, $b=1$, and $f_\zu{o}=1$.}%
