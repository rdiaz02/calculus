...
The stronger form can be proved through a somewhat tedious argument using the mean value theorem (p.~\pageref{mean-value-theorem-stated});
the interested reader can find it in the Wikipedia article on l'H\^{o}pital's rule.
