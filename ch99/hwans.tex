...
\addcontentsline{toc}{chapter}{B. Answers and solutions}
\markboth{B. Answers and Solutions}{B. Answers and Solutions}
...
\smallfig[h]{soln-check-twot-graph}{Problem \ref{hw:check-twot-graph}.}
...
\smallfig[h]{soln-graph-sin-et}{Problem \ref{hw:graph-sin-et}.}
...
\smallfig[h]{soln-inflection}{Problem \ref{hw:inflection}.}
...
\smallfig[h]{soln-neg-power-graph}{Problem \ref{hw:neg-power-graph}.}
...
\smallfig[h]{soln-lennard-jones}{Problem \ref{hw:lennard-jones}.}
...
\smallfig[h]{soln-sin-sin-sin}{Problem \ref{hw:sin-sin-sin}.}
...
\smallfig[h]{soln-limits-with-exp-one-over-x}{Problem \ref{hw:limits-with-exp-one-over-x}.}
...
\smallfig[h]{soln-integrate-sin-cancel}{Problem \ref{hw:integrate-sin-cancel}.}
...
\smallfig[h]{soln-estimate-then-integrate}{Problem \ref{hw:estimate-then-integrate}.}
