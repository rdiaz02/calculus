...
\smallfig[h]{caffeine}{Example \ref{eg:caffeine}. A typical graph of the concentration of caffeine in the blood, in units of milligrams per
...
\fig[ht]{power-ladder}{Differentiation and integration of functions of the form $x^n$. Constants
