...
\smallfig[h!]{blondin}{The famous tightrope walker Charles Blondin uses a long pole
...
\smallfig[h]{descartes}{Ren\'{e} Descartes (1596-1650)}\index{Descartes, R\'{e}ne}
...
% \fig[ht]{polar-coordinates}{Polar coordinates.}
...
\clearpage
\smallfig[ht]{polar-coordinates}{Polar coordinates.}
\smallfig[h!]{da-polar}{The differential of area in polar coordinates}
...
\smallfig[h]{poisson-trick}{The function $e^{-x^2}$, example \ref{eg:poisson-trick}.}
...
%
\fig[h!]{cylindrical-coordinates}{Cylindrical coordinates.}
...
\fig[h]{spherical-coordinates}{Spherical coordinates.}
...
\fig[hb]{hw-snail}{Problem \ref{hw:snail}: Pascal's snail with $b=1$.}
