...
\subsection{Change of variable}\label{change-of-variable-for-integration}\index{integration!methods of!change of variable}

Sometimes an unfamiliar-looking integral can be made into a familiar one by substituting a
