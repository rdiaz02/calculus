...
which is narrower than the last and therefore has less area. This means that the integral can be represented
as a decreasing, alternating series, which must converge.
