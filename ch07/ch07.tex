...
\smallfig[h]{ex-tangent}{The function $e^x$, and the tangent line at $x=0$.}
...
\smallfig[h]{ex-quadratic}{The function $e^x$, and the approximation $1+x+x^2/2$.}
...
\smallfig[h]{ex-cubic}{The function $e^x$, and the approximation $1+x+x^2/2+x^3/6$.}
%
