...
%
\smallfig[h]{gauss-square}{Adding the numbers from 1 to 7.}
%
...
%
\smallfig[h]{gauss}{Carl Friedrich Gauss (1777-1855), a long time after graduating
...
\smallfig[h]{pyramid}{A pyramid with a volume of $1^2+2^2+3^2$.}
...
\smallfig[h]{newton}{Isaac Newton (1643-1727)}\index{Newton, Isaac}
%
...
\smallfig[h]{tangent-line}{The function $x(t)=t^2/2$, and its tangent line at the point $(1,1/2)$.}
...
\smallfig[h]{scaling}{The function $t^2/2$ again. How is this different from figure \figref{tangent-line}?}
...
\smallfig[h]{curvature}{The functions $2t$, $t^2$ and $7t^2$.}
%
...
\smallfig[h]{concavity}{The functions $t^2$ and $3-t^2$.}
...
\smallfig[h]{inflection}{The functions $t^3$ has an inflection point at $t=0$.}
...
\smallfig[h]{endpoint-min}{The function $x=\sqrt t$ has a minimum at $t=0$, which is not a place where $\xdot=0$. This
...
\smallfig[h]{kink-min}{The function $x=|t|$ has a minimum at $t=0$, which is not a place where $\xdot=0$. This
