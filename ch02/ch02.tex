...
\subsection{L'H\^{o}pital's rule (simplest form)}\label{lhospital-simple}\index{l'H\^{o}pital's rule!simplest form}
...
\subsection{L'H\^{o}pital's rule (general form)}\label{lhospital-general}\index{l'H\^{o}pital's rule!general form}
...
\subsubsection{Multiple applications of the rule}\label{lhospital-multiple}
...
\subsubsection{The indeterminate form $\infty/\infty$}
...
\begin{hw}\label{hw:lhospital-at-infinity}
